...
public abstract class Tokenizer extends TokenStream {
     ...
     */
    // 待解析的数据文本 默认情况下为空   当准备解析token时 会先调用 reset() 这时就会将 inputPending 设置到 input上
     ...
     * 矫正偏移量 如果input 是普通的 reader 直接返回
     */
     ...
     */
    // 每当准备解析一个新的输入流时 会尝试复用之前的component 并通过该方法设置input
