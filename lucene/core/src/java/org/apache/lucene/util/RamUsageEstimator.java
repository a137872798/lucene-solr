...
public final class RamUsageEstimator {
  ...
  static {    
    if (Constants.JRE_IS_64BIT) {
       ...
       * 对象数组类型   ***
       *
       * 在64位jvm中  对象引用占8byte  而在32位jvm中 对象引用占4byte
       * 对象头增大其实会使得高速缓存更难命中  因为缓存能够存储的句柄就少了
       * 所以说压缩指针才有存在的意义  就是为了保持32位的性能
       */
      ...
      // 这里计算出 数组头的大小    一般情况下是在object对象头的基础上增加4字节   这4个字节是用来记录数组长度的
