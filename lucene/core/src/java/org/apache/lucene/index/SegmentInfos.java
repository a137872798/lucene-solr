 ...
 * </ul>
 *
 * @lucene.experimental 对应一组 segmentCommitInfo
 * SegmentCommitInfo 内部包含了对应的segment 的删除的doc 信息  年代信息等
 */
public final class SegmentInfos implements Cloneable, Iterable<SegmentCommitInfo> {
    ...
    public static final SegmentInfos readCommit(Directory directory, ChecksumIndexInput input, long generation) throws IOException {
        ...
        // 连续读取3个VInt值 组成一个版本号   注意 VInt 是一个变长值  就是为了压缩空间
